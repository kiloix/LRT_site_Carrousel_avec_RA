...
class Competition
{
    ...
    public function __construct($codeClub, $nomClub,  $dateDebutCompetition, $villeCompetion)    // A compléter
    {
        $this->_code = $codeClub;       // Initialisation de l'identifiant de cet objet
        $this->_nom = $nomClub;
        $this->_dateDebut = $dateDebutCompetition;
        $this->_nomPresident = $nomPresidentClub;
        $this->_ville = $villeCompetion;
    }
    ...
    public function getDateDebut()//argument $codeClub
        {
