...
class Club
{
    ...
    private $_code;                 //l'identifiant du club
    private $_nom;
    private $_adresseRue;
    private $_codePostal;
    private $_ville;
    private $_nomPresident;
    ...
    public function __construct($codeClub, $nomClub, $adresseRueClub, $codePostalClub, $villeClub, $nomPresidentClub, $numTelephoneClub, $mailClub, $urlSiteWebClub)    // A compléter
    {
        $this->_code = $codeClub;       // Initialisation de l'identifiant de cet objet
        $this->_nom = $nomClub;
        $this->_adresseRue = $adresseRueClub;
        $this->_codePostal = $codePostalClub;
        $this->_ville = $villeClub;
        $this->_nomPresident = $nomPresidentClub;
        $this->_numTelephone = $numTelephoneClub;
        $this->_mail = $mailClub;
        $this->_urlSiteWeb = $urlSiteWebClub;
    }
    ...
    //     return $this->_code; //Affichage de données de formulaire
    // }  

    // public function getNom() {//argument $codeClub
    //     return $this->_nom;
    // }

    // public function getAdresseRue()//argument $codeClub
    //     {
    //         return $this->_adresseRue;
    //     }
    // public function getCodePostal()//argument $codeClub
    //     {
    //         return $this->_codePostal;
    //     }
    // public function getVille()//argument $codeClub
    //     {
    //         return $this->_ville;
    //     }
    // public function getNomPresident()//argument $codeClub
    //     {
    //         return $this->_nomPresident;
    //     }
    // public function getNumTelephone()//argument $codeClub
    //     {
    //         return $this->_numTelephone;
    //     }
    // public function getMail()//argument $codeClub
    //     {
    //         return $this->_mail;
    //     }
    // public function getURL()//argument $codeClub
    //     {
    //         return $this->_urlSiteWeb;
    //     }
