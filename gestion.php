            ...
            <table>
                ...
                while ($ligne = $resultat->fetch()) {
                    ...
                    echo "<tr>
                            ...
                            <td>
                                <a href='modifier_membre.php?id=" . htmlspecialchars($ligne['id_personne']) . "' class='btn'>Modifier</a>
                                <a href='supprimer_membre.php?id=" . htmlspecialchars($ligne['id_personne']) . "' class='btn btn-danger' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer ce membre ?\");'>Supprimer</a>
                            </td>
                          </tr>";
                }
                ?>
